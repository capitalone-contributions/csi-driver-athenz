...
func (c *Config) addFlags(fs *flag.FlagSet) *Config {
	...
	fs.StringVar(&c.IssuerRef.Name, "issuer-name", "csi-driver-athenz-ca", "Name of issuer which has been created for the test")
	...
	fs.StringVar(&c.IssuerSecretName, "issuer-secret-name", "csi-driver-athenz-ca", "Name of the CA certificate Secret")
